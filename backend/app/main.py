...
from backend.app.api import system, projects, media, jobs, analysis, websocket, stems, time_pitch, export, spectrogram, pitch, ai, generate, mastering, mix_assistant
...
app.include_router(mix_assistant.router)
